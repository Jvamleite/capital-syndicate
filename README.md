...
# O diagrama completo está disponível em \[`DiagramaDeClasses.mermaid`](./DiagramaDeClasses.mermaid) e pode ser visualizado diretamente no GitHub ou em qualquer editor compatível com Mermaid.
